        ...
        @forelse($tshirtImages as $image)
            <div class="border rounded-lg p-4 shadow hover:shadow-lg transition flex flex-col justify-between">
                ...
                <div>
                    ...
                    {{-- Botão para o futuro: Ver detalhes / Adicionar ao carrinho --}}
                    <button class="mt-4 w-full bg-green-600 text-white py-2 rounded text-sm font-semibold hover:bg-green-700">
                        Ver Opções
                    </button>
                </div>
            </div>
