        ...
        <form action="{{ route('admin.designs.update', $tshirtImage) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="description" placeholder="Uma breve descrição sobre este design..." rows="4"
                          class="w-full px-3.5 py-2.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-900 dark:text-slate-200">{{ old('description', $tshirtImage->description) }}</textarea>
            </div>
