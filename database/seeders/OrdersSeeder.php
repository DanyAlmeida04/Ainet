...
class OrdersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $receiptUrlExpression = DB::getDriverName() === 'sqlite'
            ? "'receipt_' || CAST(id AS TEXT) || '.pdf'"
            : "CONCAT('receipt_', id, '.pdf')";
        DB::table('orders')->update(['receipt_url' => DB::raw($receiptUrlExpression)]);
